...
func (m *MockTree) Get(arg0 internal.Key) ([]internal.Row, error) {
	m.ctrl.T.Helper()
...
func (m *MockTree) ScanASC(fn func(internal.Row) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockTree) ScanDESC(fn func(internal.Row) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockTree) Set(arg0 internal.Key, arg1 internal.Row) error {
	m.ctrl.T.Helper()
